...
function grappleProjectileFlying(projectile, source){
    ...
    let fly = system.runInterval(() => {
        ...
        ((Math.abs(targetBlock.x - generalProjectile.location.x) <= 11 && Math.abs(targetBlock.y - generalProjectile.location.y) <= 11 && Math.abs(targetBlock.z - generalProjectile.location.z) <= 11) && (Math.abs(targetBlock.x - generalProjectile.location.x) > 5 && Math.abs(targetBlock.y - generalProjectile.location.y) > 5 && Math.abs(targetBlock.z - generalProjectile.location.z) > 5))? 1:
        ((Math.abs(targetBlock.x - generalProjectile.location.x) <= 5 && Math.abs(targetBlock.y - generalProjectile.location.y) <= 5 && Math.abs(targetBlock.z - generalProjectile.location.z) <= 5) && (Math.abs(targetBlock.x - generalProjectile.location.x) > 1 && Math.abs(targetBlock.y - generalProjectile.location.y) > 1 && Math.abs(targetBlock.z - generalProjectile.location.z) > 1))? 0.5:
