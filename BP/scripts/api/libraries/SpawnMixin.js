 ...
 *
 * @param {{x: number, y: number, z: number}} location - The desired spawn coordinates.
 */
Entity.prototype.setSpawnPoint = function(location) {
  ...
  if (this.dimension && this.dimension.id === "the_end") {
    ...
    if (typeof originalSetSpawnPoint === "function") {
      ...
      console.warn("Original setSpawnPoint method is undefined. Teleporting in current dimension as fallback.");
      this.teleport(location, this.dimension, 0, 0);
    }
  }
};
